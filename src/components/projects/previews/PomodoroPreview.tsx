...
export function PomodoroPreview(): React.ReactElement {
    return (
        <PreviewWindow label="Pomodoro Focus" className="flex items-center justify-center">
            <div className="w-full h-full flex items-center justify-center relative font-sans select-none">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="bg-white/5 p-8 rounded-3xl border border-white/5 shadow-2xl w-[320px] relative backdrop-blur-sm">
                            ...
                            <div className="flex justify-between items-center mb-8 cursor-default">
                                ...
                                <div className="px-4 py-1.5 inline-flex items-center rounded-full bg-transparent border border-[#10b981]/40">
                                    <span className="text-[11px] font-bold leading-none tracking-wider text-[#10b981] uppercase">Study Time — Paused</span>
                                </div>
